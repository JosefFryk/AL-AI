...
pageextension 89553 "Item Subst. Entry Copilot" extends "Item Substitution Entry"
{
    actions
    {
        addLast(Prompting)
    ...
    begin
        if Item.Get(ItemSubstitution.GetFilter("No.")) and (AzureOpenAI.IsEnabled("Copilot Capability"::"Find Item", false)) then begin
